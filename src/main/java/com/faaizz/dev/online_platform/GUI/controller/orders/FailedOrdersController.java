...
public class FailedOrdersController extends GenericOrdersController {
                    ...
                    Platform.runLater(() -> {
                        ...
                        try {
                            ...
                            if (matched_orders.getOrders().size() <= 0) {
                                setLoadingOutcomeMessage("THERE ARE NO FAILED ORDERS.");
                ...
                new Runnable(){
                    ...
                    public void run() {
                        try{
                            ...
                            HBox single_order= new SingleOrder(order.getProducts(), order);
                            // ADD TO TOPMOST VBOX
    ...
    class SingleOrder extends HBox{
        ...
        public SingleOrder(List<Map<String,String>> products, Order order) throws NumberFormatException, Exception
            {
            ...
            for(Map<String,String> ord_prod: products){
